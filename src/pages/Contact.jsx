...
function Contact() {
  return (
    <>
      <Herobanner
        image={abImage}
        heading="Contact Us – 24/7 Train Ambulance Services in India | Humancare Worldwide"
        paragraph="Need urgent train ambulance support? Contact Humancare Worldwide for safe, quick, and affordable patient transfer by rail across India. Available 24/7 with medical team, documentation, and end-to-end coordination."
