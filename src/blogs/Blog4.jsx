...
const Blog4 = () => {
    return (
        <>
            <Helmet>
                {/* Title */}
                <title>Train Ambulance in India | ICU Care on Trains for Long Distance Patient Transfer</title>
            ...
            <section className="blog-content">
                <div className="content-wrapper">
                    <p>
                        Transporting critically ill patients across long distances in India isn’t easy. While air ambulances are fast, they’re not always practical due to high costs or limited availability.
                        <br />
